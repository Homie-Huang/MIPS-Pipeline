...
public:
    Instruction_Memory()
    {
        ...
        ifstream inFile;
        inFile.open("E:/Computer_Organization/Project/Pipeline/Example1/asm.txt");
        if (inFile.is_open())
        {
        ...
        ofstream outFile("E:/Computer_Organization/Project/Pipeline/Example1/input.txt");
        ...
        //* 讀取input.txt
        ifstream file("E:/Computer_Organization/Project/Pipeline/Example1/input.txt");
        string line;
        int i = 0;
